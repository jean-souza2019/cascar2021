...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Maio-2021 às 15:38
...
INSERT INTO `anotacoes` (`id`, `titulo`, `mensagem`) VALUES
(1, 'Titulo 1', 'Teste corpo'),
(2, 'Titulo 2', 'Corpo 2 teste'),
(3, 'Estou estando o tamnho do titulo 1, esete', 'Tempo é dinheiro, todo mundo sabe disso! Consequentemente, quanto mais perde-se tempo respondendo cliente por cliente, menos dinheiro está sendo feito para a empresa. \r\nAlém disso, clientes não podem ficar esperando muito tempo por respostas, isso pode le');
...
(63, 'Jonathan Patrick Rosso', 'jonathan.rosso@gss.com', 'Tapejara', '99950000', 'SP', 0, 0, 'Fiesta', 2016, 'HATCH', 'EUN2933'),
(64, 'Jean Marcos 2', 'jean.marcos@agrodanieli.com.br', 'tapejara', '99950000', 'sp', 99999, 999999, 'Gol', 1985, 'LS', 'ii1i99');
...
(23, 'Revisão no motor', '2321321', 3200, 1, NULL);
...
(19, 7, 10, 250, '2021-05-12', '59', '16'),
(20, 7, 1, 250, '2021-05-12', '59', '21'),
(21, 8, 2, 2500, '2021-05-12', '60', '20'),
(22, 8, 3, 250, '2021-05-12', '60', '16'),
(23, 9, 1, 3200, '2021-05-12', '63', '23'),
(24, 9, 1, 250, '2021-05-12', '63', '21'),
(25, 10, 1, 3200, '2021-05-12', '59', '23'),
(26, 10, 1, 250, '2021-05-12', '59', '21'),
(27, 11, 1, 399, '2021-05-13', '64', '18');
