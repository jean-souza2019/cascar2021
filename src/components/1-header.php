...
<body>
  ...
  <div class="d-flex toggled" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="<?= SIS_URL_LISEST ?>" class="list-group-item list-group-item-action bg-light"><i class="fas fa-box-open"></i> Produtos</a>
      </div>
      <div class="list-group list-group-flush">
    ...
    <div id="page-content-wrapper">
      ...
      <nav class="navbar navbar-expand-lg navbar-primary bg-primary azulcascar">
        <div class="nav-left">
          ...
          <span class="span-usuario">Olá, <?= $usuario ?>.</span>
        </div>
